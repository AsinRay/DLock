...
public class AnnotationResolver {
    ...
    public String resolver(JoinPoint joinpoint, DistributeLock distributeLock) throws Exception {
        if (!StringUtils.isEmpty(distributeLock.key())) {
            return distributeLock.key();
        }
        MethodSignature methodSignature = (MethodSignature) joinpoint.getSignature();
        return toShortString(methodSignature.getMethod());
    }
